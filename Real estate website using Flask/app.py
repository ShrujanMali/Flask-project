...
from subscribers import createexcel, emailappend, thanksforsub 
from send_notification_mail import send_notification_mail
import os
...
def index():
    if request.method == "POST":
        ...
        newmail = post_email
        if os.path.isfile('SubscribersList.xlsx'):
            emailappend(newmail)
        else:
            createexcel(newmail)
